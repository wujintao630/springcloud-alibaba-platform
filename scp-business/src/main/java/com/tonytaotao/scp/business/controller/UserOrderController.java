...
import com.tonytaotao.scp.business.common.QueryPage;
...
public class UserOrderController {
    ...
    */
    ...
    public GlobalResult<com.tonytaotao.scp.business.entity.UserOrder> getOrderDetailById(@PathVariable Long id) {
    ...
    public GlobalResult<IPage<List<com.tonytaotao.scp.business.entity.UserOrder>>> getOrderPage(@RequestBody @ApiParam(value = "查询条件json对象", required = true) QueryPage<com.tonytaotao.scp.business.entity.UserOrder> query) {
    ...
    */
    ...
    public GlobalResult<String> saveOrUpdateOrder(@RequestBody UserOrderVO userOrderVO) {
        com.tonytaotao.scp.business.entity.UserOrder userOrder = new UserOrder();
